...
# Upstream: scripts/indicators/laguerre_rsi.py
...
def compute_multitimeframe_laguerre_rsi(
    ...
    *,
    ...
    completion_map = {
        base_index: higher_index for higher_index, base_index in enumerate(completion_indices)
    }
